## Change the working directory to the location on this computes 
...
variable_names <- list.files("data/blogsville/ncep1961-90/")
predictor_files <- paste0("data/blogsville/ncep1961-90/", variable_names)
...
tmax_predictand <- read.table("data/blogsville/observed1961-90/TMAX.DAT", stringsAsFactors = FALSE)
tmax_predictand[10105,] <- NA
tmax_predictand[,1] <- as.numeric(tmax_predictand[,1])
pcrp_predictand <- read.table("data/blogsville/observed1961-90/PRCP.DAT", stringsAsFactors = FALSE)
